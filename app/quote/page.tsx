  ...
  return (
    <div className='flex flex-col h-screen items-center justify-center bg-gradient-to-b p-8'>
      <div className="flex flex-col items-center justify-center bg-white shadow-lg border-2 border-gray-200 rounded-lg p-8 w-[90%] max-w-md text-center">
        ...
        <button
          className="px-4 py-1 bg-gray-500 text-white rounded-lg font-medium hover:bg-gray-400 transition-all shadow-md"
      ...
      <div className='mt-8'>
        <button
          className="px-6 py-2 bg-blue-500 text-white rounded-full font-semibold shadow-md hover:bg-blue-400 transition-all"
          onClick={nextIndex}
        >
          Next Quote
        </button>
