          ...
          <div className='container mx-auto px-4 w-full'>
            <div className='fixed top-0 left-0 w-full'>
              <div className='flex justify-between items-center w-full py-4 px-6'>
                ...
                <Link href="./login" className='transition hover:scale-105 active:scale-95 w-7 h-7 outline outline-2 outline-offset-4 hover:outline-offset-[3px] rounded-full outline-black'>
                  <svg
